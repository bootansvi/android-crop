...
public class Crop {
    ...
    interface Extra {
        ...
        String ERROR = "error";
        //RPP-addition for spec requirement
        String IS_ONLY_USE_MAX_SIZE = "is_only_use_max_size";
    }
    ...
    //RPP-addition for spec requirement
    /**
     * Set whether to only use max size as output or not. Set it to true if you need
     * a fixed output size as MaxSize
     * @param isUseOnlyMaxSize whether to use max size or not
     */
    public Crop useOnlyMaxSize(boolean isUseOnlyMaxSize) {
        cropIntent.putExtra(Extra.IS_ONLY_USE_MAX_SIZE, isUseOnlyMaxSize);
        return this;
    }
